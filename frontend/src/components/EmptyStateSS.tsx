 ...
 * Color scheme aligned with EmptyStateCS component
 */
      ...
      <div className="relative w-full max-w-4xl mx-auto">
        ...
        <div className="relative bg-white/90 backdrop-blur-xl rounded-lg md:rounded-2xl shadow-[0_8px_15px_-8px_rgba(0,0,0,0.15)] md:shadow-[0_15px_50px_-12px_rgba(0,0,0,0.15)] overflow-hidden border border-white/80">
          ...
          <div className="p-4 md:p-6 lg:p-12">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-center md:justify-between space-y-3 md:space-y-0 mt-3">
                          <div className="flex items-center space-x-2">
                            ...
                            <div className="flex -space-x-1">
                              <div className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-blue-100 flex items-center justify-center text-xs text-blue-500 border border-white">+8</div>
                              <div className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 border border-white"></div>
                              <div className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-gradient-to-br from-purple-500 to-blue-500 border border-white"></div>
                            </div>
                          </div>
            ...
            {/* Information card */}
            <div className="bg-gradient-to-br from-white to-blue-50/50 rounded-lg md:rounded-xl shadow-sm md:shadow-md border border-gray-100/80 p-3 md:p-5 transition-all duration-300">
              <div className="flex flex-row items-start space-x-3 md:space-x-4">
                <div className="flex-shrink-0 bg-gradient-to-br from-[#004a74]/10 to-[#0074c2]/10 p-2.5 md:p-3 rounded-lg mt-1">
                  <BookmarkIcon className="w-4 h-4 md:w-5 md:h-5 text-[#004a74]" />
                </div>
